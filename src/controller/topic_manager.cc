...
Result<void> TopicManager::CreateTopic(const std::string& name, 
                                      int32_t partitions, 
...
Result<void> TopicManager::UpdatePartitionLeader(const std::string& topic, 
                                                int32_t partition, 
  ...
  if (partition_it == partition_infos.end()) {
    return Error<void>(absl::StatusCode::kNotFound, 
...
Result<void> TopicManager::UpdatePartitionHighWaterMark(const std::string& topic, 
                                                       int32_t partition, 
...
Result<PartitionInfo> TopicManager::GetPartitionInfo(const std::string& topic, 
...
std::vector<PartitionInfo> TopicManager::GeneratePartitionAssignments(
  const std::string& topic, int32_t partitions, int32_t replication_factor) const noexcept {
