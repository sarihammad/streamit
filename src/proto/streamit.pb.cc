...
inline constexpr PollAssignmentResponse_Assignment::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        partitions_{},
        _partitions_cached_byte_size_{0},
        topic_(
            &::google::protobuf::internal::fixed_address_empty_string,
            ::_pbi::ConstantInitialized()) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PollAssignmentResponse_AssignmentDefaultTypeInternal _PollAssignmentResponse_Assignment_default_instance_;

inline constexpr PollAssignmentRequest::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        topics_{},
        group_(
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PollAssignmentRequestDefaultTypeInternal _PollAssignmentRequest_default_instance_;

inline constexpr PartitionMetadata::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        replicas_{},
        _replicas_cached_byte_size_{0},
        isr_{},
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PartitionMetadataDefaultTypeInternal _PartitionMetadata_default_instance_;

inline constexpr FindLeaderResponse::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        leader_host_(
            &::google::protobuf::internal::fixed_address_empty_string,
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FindLeaderResponseDefaultTypeInternal _FindLeaderResponse_default_instance_;

inline constexpr FindLeaderRequest::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        topic_(
            &::google::protobuf::internal::fixed_address_empty_string,
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FindLeaderRequestDefaultTypeInternal _FindLeaderRequest_default_instance_;
...
inline constexpr DescribeTopicRequest::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        topic_(
            &::google::protobuf::internal::fixed_address_empty_string,
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DescribeTopicRequestDefaultTypeInternal _DescribeTopicRequest_default_instance_;
...
inline constexpr CommitOffsetResponse::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        error_message_(
            &::google::protobuf::internal::fixed_address_empty_string,
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CommitOffsetResponseDefaultTypeInternal _CommitOffsetResponse_default_instance_;

inline constexpr CommitOffsetRequest::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        group_(
            &::google::protobuf::internal::fixed_address_empty_string,
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CommitOffsetRequestDefaultTypeInternal _CommitOffsetRequest_default_instance_;

inline constexpr TopicMetadata::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        partition_metadata_{},
        topic_(
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TopicMetadataDefaultTypeInternal _TopicMetadata_default_instance_;
    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ...
        producer_id_(
            ...
            ::_pbi::ConstantInitialized()),
        partition_{0},
        ack_{static_cast< ::streamit::v1::Ack >(0)},
        sequence_{::int64_t{0}} {}
...
inline constexpr PollAssignmentResponse::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        assignments_{},
        error_message_(
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PollAssignmentResponseDefaultTypeInternal _PollAssignmentResponse_default_instance_;
...
inline constexpr DescribeTopicResponse::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        error_message_(
            &::google::protobuf::internal::fixed_address_empty_string,
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DescribeTopicResponseDefaultTypeInternal _DescribeTopicResponse_default_instance_;
}  // namespace v1
}  // namespace streamit
static const ::_pb::EnumDescriptor* PROTOBUF_NONNULL
    file_level_enum_descriptors_proto_2fstreamit_2eproto[2];
static constexpr const ::_pb::ServiceDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_service_descriptors_proto_2fstreamit_2eproto = nullptr;
const ::uint32_t
    TableStruct_proto_2fstreamit_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
...
const char descriptor_table_protodef_proto_2fstreamit_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
Record::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastBS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(Record, _impl_.key_)}},
    // bytes value = 2;
    {::_pbi::TcParser::FastBS1,
     {18, 1, 0, PROTOBUF_FIELD_OFFSET(Record, _impl_.value_)}},
    ...
    // bytes key = 1;
    {PROTOBUF_FIELD_OFFSET(Record, _impl_.key_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
    // bytes value = 2;
    {PROTOBUF_FIELD_OFFSET(Record, _impl_.value_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
    // int64 timestamp_ms = 3;
    {PROTOBUF_FIELD_OFFSET(Record, _impl_.timestamp_ms_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
  }},
  // no aux_entries
  {{
  }},
...
class RecordBatch::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<RecordBatch>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(RecordBatch, _impl_._has_bits_);
};
...
inline void* PROTOBUF_NONNULL RecordBatch::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
  return ::new (mem) RecordBatch(arena);
}
constexpr auto RecordBatch::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(RecordBatch),
                                            alignof(RecordBatch));
}
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull RecordBatch_class_data_ =
        RecordBatch::InternalGenerateClassData_();
...
RecordBatch::_table_ = {
  {
    ...
    // bytes payload = 2;
    {::_pbi::TcParser::FastBS1,
     {18, 0, 0, PROTOBUF_FIELD_OFFSET(RecordBatch, _impl_.payload_)}},
    // uint32 crc32 = 3;
    ...
    // int64 base_offset = 1;
    {PROTOBUF_FIELD_OFFSET(RecordBatch, _impl_.base_offset_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
    // bytes payload = 2;
    {PROTOBUF_FIELD_OFFSET(RecordBatch, _impl_.payload_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
    // uint32 crc32 = 3;
    {PROTOBUF_FIELD_OFFSET(RecordBatch, _impl_.crc32_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
  }},
  // no aux_entries
  {{
  }},
...
// @@protoc_insertion_point(message_clear_start:streamit.v1.RecordBatch)
  ...
  if ((cached_has_bits & 0x00000006U) != 0) {
    ::memset(&_impl_.base_offset_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.base_offset_)) + sizeof(_impl_.crc32_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000004U) != 0) {
    if (this_._internal_crc32() != 0) {
      ...
      target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
          3, this_._internal_crc32(), target);
    }
  }
...
void RecordBatch::InternalSwap(RecordBatch* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RecordBatch, _impl_.crc32_)
      ...
      - PROTOBUF_FIELD_OFFSET(RecordBatch, _impl_.base_offset_)>(
          ...
          reinterpret_cast<char*>(&other->_impl_.base_offset_));
}
...
class ProduceRequest::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<ProduceRequest>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
...
inline void* PROTOBUF_NONNULL ProduceRequest::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto ProduceRequest::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.records_) +
          decltype(ProduceRequest::_impl_.records_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
  });
  if (arena_bits.has_value()) {
    return ::google::protobuf::internal::MessageCreator::CopyInit(
        sizeof(ProduceRequest), alignof(ProduceRequest), *arena_bits);
  } else {
    return ::google::protobuf::internal::MessageCreator(&ProduceRequest::PlacementNew_,
                                 sizeof(ProduceRequest),
...
constexpr auto ProduceRequest::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<ProduceRequest>(), &ProduceRequest::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull ProduceRequest_class_data_ =
        ProduceRequest::InternalGenerateClassData_();
...
ProduceRequest::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.topic_)}},
    // int32 partition = 2;
    ...
    {::_pbi::TcParser::FastMtR1,
     {26, 63, 0, PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.records_)}},
    ...
    {::_pbi::TcParser::FastUS1,
     {42, 1, 0, PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.producer_id_)}},
    // int64 sequence = 6;
    ...
    // string topic = 1;
    {PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.topic_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 partition = 2;
    {PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.partition_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // repeated .streamit.v1.Record records = 3;
    {PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.records_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // .streamit.v1.Ack ack = 4;
    {PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.ack_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // string producer_id = 5;
    {PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.producer_id_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int64 sequence = 6;
    {PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.sequence_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
  }},
  {{
...
// @@protoc_insertion_point(message_clear_start:streamit.v1.ProduceRequest)
  ...
  if ((cached_has_bits & 0x0000001cU) != 0) {
    ::memset(&_impl_.partition_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.partition_)) + sizeof(_impl_.sequence_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
...
::uint8_t* PROTOBUF_NONNULL ProduceRequest::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_topic().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.ProduceRequest.topic");
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000002U) != 0) {
    if (!this_._internal_producer_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.ProduceRequest.producer_id");
...
::size_t ProduceRequest::ByteSizeLong() const {
  ...
  if ((cached_has_bits & 0x0000001fU) != 0) {
    ...
    if ((cached_has_bits & 0x00000008U) != 0) {
      if (this_._internal_ack() != 0) {
        total_size += 1 +
                      ::_pbi::WireFormatLite::EnumSize(this_._internal_ack());
      }
    }
    // int64 sequence = 6;
...
void ProduceRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
void ProduceRequest::InternalSwap(ProduceRequest* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ProduceRequest, _impl_.sequence_)
...
class ProduceResponse::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<ProduceResponse>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(ProduceResponse, _impl_._has_bits_);
};
...
inline void* PROTOBUF_NONNULL ProduceResponse::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
  return ::new (mem) ProduceResponse(arena);
}
constexpr auto ProduceResponse::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(ProduceResponse),
                                            alignof(ProduceResponse));
}
constexpr auto ProduceResponse::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<ProduceResponse>(), &ProduceResponse::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull ProduceResponse_class_data_ =
        ProduceResponse::InternalGenerateClassData_();
...
ProduceResponse::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {26, 0, 0, PROTOBUF_FIELD_OFFSET(ProduceResponse, _impl_.error_message_)}},
    ...
    {::_pbi::TcParser::FastUS1,
     {42, 1, 0, PROTOBUF_FIELD_OFFSET(ProduceResponse, _impl_.leader_hint_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    // int64 base_offset = 1;
    {PROTOBUF_FIELD_OFFSET(ProduceResponse, _impl_.base_offset_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
    // .streamit.v1.ErrorCode error_code = 2;
    {PROTOBUF_FIELD_OFFSET(ProduceResponse, _impl_.error_code_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // string error_message = 3;
    {PROTOBUF_FIELD_OFFSET(ProduceResponse, _impl_.error_message_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 retry_after_ms = 4;
    {PROTOBUF_FIELD_OFFSET(ProduceResponse, _impl_.retry_after_ms_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // string leader_hint = 5;
    {PROTOBUF_FIELD_OFFSET(ProduceResponse, _impl_.leader_hint_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\33\0\0\15\0\13\0\0"
...
// @@protoc_insertion_point(message_clear_start:streamit.v1.ProduceResponse)
  ...
  if ((cached_has_bits & 0x0000001cU) != 0) {
    ::memset(&_impl_.base_offset_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.base_offset_)) + sizeof(_impl_.retry_after_ms_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
...
::uint8_t* PROTOBUF_NONNULL ProduceResponse::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_error_message().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.ProduceResponse.error_message");
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000002U) != 0) {
    if (!this_._internal_leader_hint().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.ProduceResponse.leader_hint");
      target = stream->WriteStringMaybeAliased(5, _s, target);
    }
  }
...
void ProduceResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
void ProduceResponse::InternalSwap(ProduceResponse* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ProduceResponse, _impl_.retry_after_ms_)
...
class FetchRequest::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<FetchRequest>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(FetchRequest, _impl_._has_bits_);
};
...
constexpr auto FetchRequest::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(FetchRequest),
...
FetchRequest::_table_ = {
  {
    ...
    // string topic = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(FetchRequest, _impl_.topic_)}},
    // int32 partition = 2;
    ...
    // string topic = 1;
    {PROTOBUF_FIELD_OFFSET(FetchRequest, _impl_.topic_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 partition = 2;
    {PROTOBUF_FIELD_OFFSET(FetchRequest, _impl_.partition_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // int64 offset = 3;
    {PROTOBUF_FIELD_OFFSET(FetchRequest, _impl_.offset_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
    // int32 max_bytes = 4;
    {PROTOBUF_FIELD_OFFSET(FetchRequest, _impl_.max_bytes_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
    "\30\5\0\0\0\0\0\0"
...
// @@protoc_insertion_point(message_clear_start:streamit.v1.FetchRequest)
  ...
  if ((cached_has_bits & 0x0000000eU) != 0) {
    ::memset(&_impl_.offset_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.offset_)) + sizeof(_impl_.max_bytes_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
...
::uint8_t* PROTOBUF_NONNULL FetchRequest::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_topic().empty()) {
      const ::std::string& _s = this_._internal_topic();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.FetchRequest.topic");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
...
void FetchRequest::InternalSwap(FetchRequest* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.topic_, &other->_impl_.topic_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FetchRequest, _impl_.max_bytes_)
...
PROTOBUF_NDEBUG_INLINE FetchResponse::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::streamit::v1::FetchResponse& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        batches_{visibility, arena, from.batches_},
        error_message_(arena, from.error_message_),
        leader_hint_(arena, from.leader_hint_) {}
...
FetchResponse::FetchResponse(
  ...
  new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
  ::memcpy(reinterpret_cast<char *>(&_impl_) +
               offsetof(Impl_, high_watermark_),
           reinterpret_cast<const char *>(&from._impl_) +
               offsetof(Impl_, high_watermark_),
           offsetof(Impl_, retry_after_ms_) -
               offsetof(Impl_, high_watermark_) +
...
constexpr auto FetchResponse::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.batches_) +
          decltype(FetchResponse::_impl_.batches_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
  });
  if (arena_bits.has_value()) {
    return ::google::protobuf::internal::MessageCreator::CopyInit(
        sizeof(FetchResponse), alignof(FetchResponse), *arena_bits);
  } else {
    return ::google::protobuf::internal::MessageCreator(&FetchResponse::PlacementNew_,
...
FetchResponse::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastMtR1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.batches_)}},
    ...
    {::_pbi::TcParser::FastUS1,
     {34, 0, 0, PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.error_message_)}},
    ...
    {::_pbi::TcParser::FastUS1,
     {50, 1, 0, PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.leader_hint_)}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
  }}, {{
    // int64 high_watermark = 1;
    {PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.high_watermark_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
    // repeated .streamit.v1.RecordBatch batches = 2;
    {PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.batches_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // .streamit.v1.ErrorCode error_code = 3;
    {PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.error_code_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // string error_message = 4;
    {PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.error_message_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 retry_after_ms = 5;
    {PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.retry_after_ms_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // string leader_hint = 6;
    {PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.leader_hint_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  {{
...
// @@protoc_insertion_point(message_clear_start:streamit.v1.FetchResponse)
  ...
  if ((cached_has_bits & 0x0000001cU) != 0) {
    ::memset(&_impl_.high_watermark_, 0, static_cast<::size_t>(
        reinterpret_cast<char*>(&_impl_.retry_after_ms_) -
        reinterpret_cast<char*>(&_impl_.high_watermark_)) + sizeof(_impl_.retry_after_ms_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
...
::uint8_t* PROTOBUF_NONNULL FetchResponse::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_error_message().empty()) {
      const ::std::string& _s = this_._internal_error_message();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.FetchResponse.error_message");
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000002U) != 0) {
    if (!this_._internal_leader_hint().empty()) {
      const ::std::string& _s = this_._internal_leader_hint();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.FetchResponse.leader_hint");
...
::size_t FetchResponse::ByteSizeLong() const {
  ...
  if ((cached_has_bits & 0x0000001fU) != 0) {
    ...
    if ((cached_has_bits & 0x00000004U) != 0) {
      if (this_._internal_high_watermark() != 0) {
        total_size += ::_pbi::WireFormatLite::Int64SizePlusOne(
            this_._internal_high_watermark());
      }
    }
    // .streamit.v1.ErrorCode error_code = 3;
    if ((cached_has_bits & 0x00000008U) != 0) {
...
void FetchResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  _this->_internal_mutable_batches()->MergeFrom(
      from._internal_batches());
  cached_has_bits = from._impl_._has_bits_[0];
  if ((cached_has_bits & 0x0000001fU) != 0) {
    if ((cached_has_bits & 0x00000001U) != 0) {
      if (!from._internal_error_message().empty()) {
...
void FetchResponse::InternalSwap(FetchResponse* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.leader_hint_, &other->_impl_.leader_hint_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.retry_after_ms_)
      ...
      - PROTOBUF_FIELD_OFFSET(FetchResponse, _impl_.high_watermark_)>(
          ...
          reinterpret_cast<char*>(&other->_impl_.high_watermark_));
}
...
class CommitOffsetRequest::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<CommitOffsetRequest>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(CommitOffsetRequest, _impl_._has_bits_);
};
...
inline void* PROTOBUF_NONNULL CommitOffsetRequest::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto CommitOffsetRequest::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<CommitOffsetRequest>(), &CommitOffsetRequest::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull CommitOffsetRequest_class_data_ =
        CommitOffsetRequest::InternalGenerateClassData_();
...
CommitOffsetRequest::_table_ = {
  {
    ...
    // string group = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(CommitOffsetRequest, _impl_.group_)}},
    // string topic = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 1, 0, PROTOBUF_FIELD_OFFSET(CommitOffsetRequest, _impl_.topic_)}},
    // int32 partition = 3;
    ...
    // string group = 1;
    {PROTOBUF_FIELD_OFFSET(CommitOffsetRequest, _impl_.group_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string topic = 2;
    {PROTOBUF_FIELD_OFFSET(CommitOffsetRequest, _impl_.topic_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 partition = 3;
    {PROTOBUF_FIELD_OFFSET(CommitOffsetRequest, _impl_.partition_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // int64 offset = 4;
    {PROTOBUF_FIELD_OFFSET(CommitOffsetRequest, _impl_.offset_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
  }},
  // no aux_entries
  {{
    "\37\5\5\0\0\0\0\0"
...
::uint8_t* PROTOBUF_NONNULL CommitOffsetRequest::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_group().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.CommitOffsetRequest.group");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000002U) != 0) {
    if (!this_._internal_topic().empty()) {
      const ::std::string& _s = this_._internal_topic();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.CommitOffsetRequest.topic");
...
void CommitOffsetRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
void CommitOffsetRequest::InternalSwap(CommitOffsetRequest* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.topic_, &other->_impl_.topic_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CommitOffsetRequest, _impl_.partition_)
...
class CommitOffsetResponse::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<CommitOffsetResponse>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(CommitOffsetResponse, _impl_._has_bits_);
};
...
inline void* PROTOBUF_NONNULL CommitOffsetResponse::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto CommitOffsetResponse::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<CommitOffsetResponse>(), &CommitOffsetResponse::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull CommitOffsetResponse_class_data_ =
        CommitOffsetResponse::InternalGenerateClassData_();
...
CommitOffsetResponse::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {18, 0, 0, PROTOBUF_FIELD_OFFSET(CommitOffsetResponse, _impl_.error_message_)}},
    // .streamit.v1.ErrorCode error_code = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(CommitOffsetResponse, _impl_.error_code_), 1>(),
     {8, 1, 0, PROTOBUF_FIELD_OFFSET(CommitOffsetResponse, _impl_.error_code_)}},
  }}, {{
    65535, 65535
  }}, {{
    // .streamit.v1.ErrorCode error_code = 1;
    {PROTOBUF_FIELD_OFFSET(CommitOffsetResponse, _impl_.error_code_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // string error_message = 2;
    {PROTOBUF_FIELD_OFFSET(CommitOffsetResponse, _impl_.error_message_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\40\0\15\0\0\0\0\0"
...
::uint8_t* PROTOBUF_NONNULL CommitOffsetResponse::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_error_message().empty()) {
      const ::std::string& _s = this_._internal_error_message();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.CommitOffsetResponse.error_message");
      target = stream->WriteStringMaybeAliased(2, _s, target);
    }
  }
...
void CommitOffsetResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
class PollAssignmentRequest::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<PollAssignmentRequest>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(PollAssignmentRequest, _impl_._has_bits_);
};
...
inline void* PROTOBUF_NONNULL PollAssignmentRequest::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto PollAssignmentRequest::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(PollAssignmentRequest, _impl_.topics_) +
          decltype(PollAssignmentRequest::_impl_.topics_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
  });
  if (arena_bits.has_value()) {
    return ::google::protobuf::internal::MessageCreator::CopyInit(
        sizeof(PollAssignmentRequest), alignof(PollAssignmentRequest), *arena_bits);
  } else {
    return ::google::protobuf::internal::MessageCreator(&PollAssignmentRequest::PlacementNew_,
                                 sizeof(PollAssignmentRequest),
                                 alignof(PollAssignmentRequest));
  }
}
constexpr auto PollAssignmentRequest::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<PollAssignmentRequest>(), &PollAssignmentRequest::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull PollAssignmentRequest_class_data_ =
        PollAssignmentRequest::InternalGenerateClassData_();
...
PollAssignmentRequest::_table_ = {
  {
    ...
    // string group = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(PollAssignmentRequest, _impl_.group_)}},
    // string member_id = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 1, 0, PROTOBUF_FIELD_OFFSET(PollAssignmentRequest, _impl_.member_id_)}},
    // repeated string topics = 3;
    {::_pbi::TcParser::FastUR1,
     {26, 63, 0, PROTOBUF_FIELD_OFFSET(PollAssignmentRequest, _impl_.topics_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string group = 1;
    {PROTOBUF_FIELD_OFFSET(PollAssignmentRequest, _impl_.group_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string member_id = 2;
    {PROTOBUF_FIELD_OFFSET(PollAssignmentRequest, _impl_.member_id_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // repeated string topics = 3;
    {PROTOBUF_FIELD_OFFSET(PollAssignmentRequest, _impl_.topics_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kUtf8String | ::_fl::kRepSString)},
  }},
  // no aux_entries
  {{
    "\41\5\11\6\0\0\0\0"
...
::uint8_t* PROTOBUF_NONNULL PollAssignmentRequest::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_group().empty()) {
      const ::std::string& _s = this_._internal_group();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.PollAssignmentRequest.group");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000002U) != 0) {
    if (!this_._internal_member_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.PollAssignmentRequest.member_id");
      target = stream->WriteStringMaybeAliased(2, _s, target);
    }
  }
  ...
  for (int i = 0, n = this_._internal_topics_size(); i < n; ++i) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.PollAssignmentRequest.topics");
...
void PollAssignmentRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
class PollAssignmentResponse_Assignment::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<PollAssignmentResponse_Assignment>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
...
constexpr auto PollAssignmentResponse_Assignment::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(PollAssignmentResponse_Assignment, _impl_.partitions_) +
          decltype(PollAssignmentResponse_Assignment::_impl_.partitions_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
  });
  if (arena_bits.has_value()) {
...
constexpr auto PollAssignmentResponse_Assignment::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<PollAssignmentResponse_Assignment>(), &PollAssignmentResponse_Assignment::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull PollAssignmentResponse_Assignment_class_data_ =
        PollAssignmentResponse_Assignment::InternalGenerateClassData_();
...
PollAssignmentResponse_Assignment::_table_ = {
  {
    ...
    // string topic = 1;
    {PROTOBUF_FIELD_OFFSET(PollAssignmentResponse_Assignment, _impl_.topic_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // repeated int32 partitions = 2;
    {PROTOBUF_FIELD_OFFSET(PollAssignmentResponse_Assignment, _impl_.partitions_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kPackedInt32)},
  }},
  // no aux_entries
  {{
    "\55\5\0\0\0\0\0\0"
...
::uint8_t* PROTOBUF_NONNULL PollAssignmentResponse_Assignment::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_topic().empty()) {
      const ::std::string& _s = this_._internal_topic();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.PollAssignmentResponse.Assignment.topic");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  // repeated int32 partitions = 2;
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
          2, this_._internal_partitions(), byte_size, target);
    }
  }
...
void PollAssignmentResponse_Assignment::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
void PollAssignmentResponse_Assignment::InternalSwap(PollAssignmentResponse_Assignment* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  auto* arena = GetArena();
  ABSL_DCHECK_EQ(arena, other->GetArena());
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
class PollAssignmentResponse::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<PollAssignmentResponse>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(PollAssignmentResponse, _impl_._has_bits_);
};
...
PollAssignmentResponse::PollAssignmentResponse(
  ...
  new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
  ::memcpy(reinterpret_cast<char *>(&_impl_) +
               offsetof(Impl_, heartbeat_interval_ms_),
           reinterpret_cast<const char *>(&from._impl_) +
               offsetof(Impl_, heartbeat_interval_ms_),
...
constexpr auto PollAssignmentResponse::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(PollAssignmentResponse, _impl_.assignments_) +
          decltype(PollAssignmentResponse::_impl_.assignments_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
  });
  if (arena_bits.has_value()) {
    return ::google::protobuf::internal::MessageCreator::CopyInit(
        sizeof(PollAssignmentResponse), alignof(PollAssignmentResponse), *arena_bits);
  } else {
    return ::google::protobuf::internal::MessageCreator(&PollAssignmentResponse::PlacementNew_,
                                 sizeof(PollAssignmentResponse),
                                 alignof(PollAssignmentResponse));
  }
}
constexpr auto PollAssignmentResponse::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<PollAssignmentResponse>(), &PollAssignmentResponse::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull PollAssignmentResponse_class_data_ =
        PollAssignmentResponse::InternalGenerateClassData_();
...
PollAssignmentResponse::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(PollAssignmentResponse, _impl_.heartbeat_interval_ms_), 1>(),
     {16, 1, 0, PROTOBUF_FIELD_OFFSET(PollAssignmentResponse, _impl_.heartbeat_interval_ms_)}},
    // .streamit.v1.ErrorCode error_code = 3;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(PollAssignmentResponse, _impl_.error_code_), 2>(),
     {24, 2, 0, PROTOBUF_FIELD_OFFSET(PollAssignmentResponse, _impl_.error_code_)}},
  }}, {{
    65535, 65535
  }}, {{
    // repeated .streamit.v1.PollAssignmentResponse.Assignment assignments = 1;
    {PROTOBUF_FIELD_OFFSET(PollAssignmentResponse, _impl_.assignments_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // int32 heartbeat_interval_ms = 2;
    {PROTOBUF_FIELD_OFFSET(PollAssignmentResponse, _impl_.heartbeat_interval_ms_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // .streamit.v1.ErrorCode error_code = 3;
    {PROTOBUF_FIELD_OFFSET(PollAssignmentResponse, _impl_.error_code_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // string error_message = 4;
    {PROTOBUF_FIELD_OFFSET(PollAssignmentResponse, _impl_.error_message_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  {{
...
// @@protoc_insertion_point(message_clear_start:streamit.v1.PollAssignmentResponse)
  ...
  if ((cached_has_bits & 0x00000006U) != 0) {
    ::memset(&_impl_.heartbeat_interval_ms_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.heartbeat_interval_ms_)) + sizeof(_impl_.error_code_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
...
::uint8_t* PROTOBUF_NONNULL PollAssignmentResponse::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_error_message().empty()) {
      const ::std::string& _s = this_._internal_error_message();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.PollAssignmentResponse.error_message");
      target = stream->WriteStringMaybeAliased(4, _s, target);
    }
  }
...
void PollAssignmentResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
void PollAssignmentResponse::InternalSwap(PollAssignmentResponse* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.error_message_, &other->_impl_.error_message_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PollAssignmentResponse, _impl_.error_code_)
...
CreateTopicRequest::_table_ = {
  {
    ...
    // string topic = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(CreateTopicRequest, _impl_.topic_)}},
    // int32 partitions = 2;
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(CreateTopicRequest, _impl_.replication_factor_), 2>(),
     {24, 2, 0, PROTOBUF_FIELD_OFFSET(CreateTopicRequest, _impl_.replication_factor_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string topic = 1;
    {PROTOBUF_FIELD_OFFSET(CreateTopicRequest, _impl_.topic_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 partitions = 2;
    {PROTOBUF_FIELD_OFFSET(CreateTopicRequest, _impl_.partitions_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // int32 replication_factor = 3;
    {PROTOBUF_FIELD_OFFSET(CreateTopicRequest, _impl_.replication_factor_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
    "\36\5\0\0\0\0\0\0"
...
// @@protoc_insertion_point(message_clear_start:streamit.v1.CreateTopicRequest)
  ...
  if ((cached_has_bits & 0x00000006U) != 0) {
    ::memset(&_impl_.partitions_, 0, static_cast<::size_t>(
        reinterpret_cast<char*>(&_impl_.replication_factor_) -
        reinterpret_cast<char*>(&_impl_.partitions_)) + sizeof(_impl_.replication_factor_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
...
::uint8_t* PROTOBUF_NONNULL CreateTopicRequest::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_topic().empty()) {
      const ::std::string& _s = this_._internal_topic();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.CreateTopicRequest.topic");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
...
void CreateTopicRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
void CreateTopicRequest::InternalSwap(CreateTopicRequest* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.topic_, &other->_impl_.topic_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CreateTopicRequest, _impl_.replication_factor_)
      ...
      - PROTOBUF_FIELD_OFFSET(CreateTopicRequest, _impl_.partitions_)>(
          ...
          reinterpret_cast<char*>(&other->_impl_.partitions_));
}
...
CreateTopicResponse::_table_ = {
  {
    ...
    // string error_message = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 0, 0, PROTOBUF_FIELD_OFFSET(CreateTopicResponse, _impl_.error_message_)}},
    // .streamit.v1.ErrorCode error_code = 3;
    ...
    // bool success = 1;
    {PROTOBUF_FIELD_OFFSET(CreateTopicResponse, _impl_.success_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    // string error_message = 2;
    {PROTOBUF_FIELD_OFFSET(CreateTopicResponse, _impl_.error_message_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // .streamit.v1.ErrorCode error_code = 3;
    {PROTOBUF_FIELD_OFFSET(CreateTopicResponse, _impl_.error_code_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
  }},
  // no aux_entries
  {{
    "\37\0\15\0\0\0\0\0"
...
::uint8_t* PROTOBUF_NONNULL CreateTopicResponse::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_error_message().empty()) {
      const ::std::string& _s = this_._internal_error_message();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.CreateTopicResponse.error_message");
      target = stream->WriteStringMaybeAliased(2, _s, target);
    }
  }
...
void CreateTopicResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
void CreateTopicResponse::InternalSwap(CreateTopicResponse* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.error_message_, &other->_impl_.error_message_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CreateTopicResponse, _impl_.error_code_)
...
class TopicMetadata::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<TopicMetadata>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(TopicMetadata, _impl_._has_bits_);
};
...
PROTOBUF_NDEBUG_INLINE TopicMetadata::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::streamit::v1::TopicMetadata& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        partition_metadata_{visibility, arena, from.partition_metadata_},
        topic_(arena, from.topic_) {}

TopicMetadata::TopicMetadata(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena,
    const TopicMetadata& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, TopicMetadata_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
PROTOBUF_NDEBUG_INLINE TopicMetadata::Impl_::Impl_(
    ...
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
      : _cached_size_{0},
        partition_metadata_{visibility, arena},
        topic_(arena) {}
...
inline void* PROTOBUF_NONNULL TopicMetadata::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto TopicMetadata::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(TopicMetadata, _impl_.partition_metadata_) +
          decltype(TopicMetadata::_impl_.partition_metadata_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
  });
  if (arena_bits.has_value()) {
    return ::google::protobuf::internal::MessageCreator::CopyInit(
        sizeof(TopicMetadata), alignof(TopicMetadata), *arena_bits);
  } else {
    return ::google::protobuf::internal::MessageCreator(&TopicMetadata::PlacementNew_,
...
constexpr auto TopicMetadata::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<TopicMetadata>(), &TopicMetadata::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull TopicMetadata_class_data_ =
        TopicMetadata::InternalGenerateClassData_();
...
TopicMetadata::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastMtR1,
     {34, 63, 0, PROTOBUF_FIELD_OFFSET(TopicMetadata, _impl_.partition_metadata_)}},
    // string topic = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(TopicMetadata, _impl_.topic_)}},
    // int32 partitions = 2;
    ...
    // int32 replication_factor = 3;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(TopicMetadata, _impl_.replication_factor_), 2>(),
     {24, 2, 0, PROTOBUF_FIELD_OFFSET(TopicMetadata, _impl_.replication_factor_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string topic = 1;
    {PROTOBUF_FIELD_OFFSET(TopicMetadata, _impl_.topic_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 partitions = 2;
    {PROTOBUF_FIELD_OFFSET(TopicMetadata, _impl_.partitions_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // int32 replication_factor = 3;
    {PROTOBUF_FIELD_OFFSET(TopicMetadata, _impl_.replication_factor_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // repeated .streamit.v1.PartitionMetadata partition_metadata = 4;
    {PROTOBUF_FIELD_OFFSET(TopicMetadata, _impl_.partition_metadata_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
  }},
  {{
...
::uint8_t* PROTOBUF_NONNULL TopicMetadata::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_topic().empty()) {
      const ::std::string& _s = this_._internal_topic();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.TopicMetadata.topic");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  // repeated .streamit.v1.PartitionMetadata partition_metadata = 4;
  for (unsigned i = 0, n = static_cast<unsigned>(
                           this_._internal_partition_metadata_size());
       i < n; i++) {
...
void TopicMetadata::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  _this->_internal_mutable_partition_metadata()->MergeFrom(
      from._internal_partition_metadata());
  cached_has_bits = from._impl_._has_bits_[0];
  if ((cached_has_bits & 0x00000007U) != 0) {
    if ((cached_has_bits & 0x00000001U) != 0) {
      if (!from._internal_topic().empty()) {
...
void TopicMetadata::InternalSwap(TopicMetadata* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.topic_, &other->_impl_.topic_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TopicMetadata, _impl_.replication_factor_)
...
class PartitionMetadata::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<PartitionMetadata>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(PartitionMetadata, _impl_._has_bits_);
};
...
PROTOBUF_NDEBUG_INLINE PartitionMetadata::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::streamit::v1::PartitionMetadata& from_msg)
      : _has_bits_{from._has_bits_},
        ...
        _replicas_cached_byte_size_{0},
        isr_{visibility, arena, from.isr_},
        _isr_cached_byte_size_{0} {}

PartitionMetadata::PartitionMetadata(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena,
    const PartitionMetadata& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, PartitionMetadata_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline void* PROTOBUF_NONNULL PartitionMetadata::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto PartitionMetadata::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(PartitionMetadata, _impl_.replicas_) +
          decltype(PartitionMetadata::_impl_.replicas_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
      PROTOBUF_FIELD_OFFSET(PartitionMetadata, _impl_.isr_) +
          decltype(PartitionMetadata::_impl_.isr_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
  });
  if (arena_bits.has_value()) {
    return ::google::protobuf::internal::MessageCreator::ZeroInit(
        sizeof(PartitionMetadata), alignof(PartitionMetadata), *arena_bits);
  } else {
    return ::google::protobuf::internal::MessageCreator(&PartitionMetadata::PlacementNew_,
                                 sizeof(PartitionMetadata),
...
constexpr auto PartitionMetadata::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<PartitionMetadata>(), &PartitionMetadata::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull PartitionMetadata_class_data_ =
        PartitionMetadata::InternalGenerateClassData_();
...
PartitionMetadata::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastV32P1,
     {34, 63, 0, PROTOBUF_FIELD_OFFSET(PartitionMetadata, _impl_.isr_)}},
    // int32 partition = 1;
    ...
    {::_pbi::TcParser::FastV32P1,
     {26, 63, 0, PROTOBUF_FIELD_OFFSET(PartitionMetadata, _impl_.replicas_)}},
  }}, {{
    65535, 65535
  }}, {{
    // int32 partition = 1;
    {PROTOBUF_FIELD_OFFSET(PartitionMetadata, _impl_.partition_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // int32 leader = 2;
    {PROTOBUF_FIELD_OFFSET(PartitionMetadata, _impl_.leader_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // repeated int32 replicas = 3;
    {PROTOBUF_FIELD_OFFSET(PartitionMetadata, _impl_.replicas_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kPackedInt32)},
    // repeated int32 isr = 4;
    {PROTOBUF_FIELD_OFFSET(PartitionMetadata, _impl_.isr_), -1, 0, (0 | ::_fl::kFcRepeated | ::_fl::kPackedInt32)},
  }},
  // no aux_entries
  {{
  }},
...
// @@protoc_insertion_point(message_clear_start:streamit.v1.PartitionMetadata)
  ...
  if ((cached_has_bits & 0x00000003U) != 0) {
    ::memset(&_impl_.partition_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.partition_)) + sizeof(_impl_.leader_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
...
::uint8_t* PROTOBUF_NONNULL PartitionMetadata::_InternalSerialize(
  ...
  // repeated int32 replicas = 3;
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
          3, this_._internal_replicas(), byte_size, target);
    }
  }
  ...
  // repeated int32 isr = 4;
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
          4, this_._internal_isr(), byte_size, target);
    }
  }
...
void PartitionMetadata::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
void PartitionMetadata::InternalSwap(PartitionMetadata* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PartitionMetadata, _impl_.leader_)
...
class DescribeTopicRequest::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<DescribeTopicRequest>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(DescribeTopicRequest, _impl_._has_bits_);
};
...
inline void* PROTOBUF_NONNULL DescribeTopicRequest::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto DescribeTopicRequest::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<DescribeTopicRequest>(), &DescribeTopicRequest::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull DescribeTopicRequest_class_data_ =
        DescribeTopicRequest::InternalGenerateClassData_();
...
DescribeTopicRequest::_table_ = {
  {
    ...
    // string topic = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(DescribeTopicRequest, _impl_.topic_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string topic = 1;
    {PROTOBUF_FIELD_OFFSET(DescribeTopicRequest, _impl_.topic_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\40\5\0\0\0\0\0\0"
...
::uint8_t* PROTOBUF_NONNULL DescribeTopicRequest::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_topic().empty()) {
      const ::std::string& _s = this_._internal_topic();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.DescribeTopicRequest.topic");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
...
void DescribeTopicRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
class DescribeTopicResponse::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<DescribeTopicResponse>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(DescribeTopicResponse, _impl_._has_bits_);
};
...
inline void* PROTOBUF_NONNULL DescribeTopicResponse::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto DescribeTopicResponse::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<DescribeTopicResponse>(), &DescribeTopicResponse::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull DescribeTopicResponse_class_data_ =
        DescribeTopicResponse::InternalGenerateClassData_();
...
DescribeTopicResponse::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastMtS1,
     {10, 1, 0, PROTOBUF_FIELD_OFFSET(DescribeTopicResponse, _impl_.metadata_)}},
    // .streamit.v1.ErrorCode error_code = 2;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(DescribeTopicResponse, _impl_.error_code_), 2>(),
    ...
    // .streamit.v1.TopicMetadata metadata = 1;
    {PROTOBUF_FIELD_OFFSET(DescribeTopicResponse, _impl_.metadata_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // .streamit.v1.ErrorCode error_code = 2;
    {PROTOBUF_FIELD_OFFSET(DescribeTopicResponse, _impl_.error_code_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // string error_message = 3;
    {PROTOBUF_FIELD_OFFSET(DescribeTopicResponse, _impl_.error_message_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  {{
...
::uint8_t* PROTOBUF_NONNULL DescribeTopicResponse::_InternalSerialize(
  ...
  if ((cached_has_bits & 0x00000001U) != 0) {
    if (!this_._internal_error_message().empty()) {
      const ::std::string& _s = this_._internal_error_message();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.DescribeTopicResponse.error_message");
      target = stream->WriteStringMaybeAliased(3, _s, target);
    }
  }
...
void DescribeTopicResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
void DescribeTopicResponse::InternalSwap(DescribeTopicResponse* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.error_message_, &other->_impl_.error_message_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DescribeTopicResponse, _impl_.error_code_)
...
class FindLeaderRequest::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<FindLeaderRequest>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(FindLeaderRequest, _impl_._has_bits_);
};
...
inline void* PROTOBUF_NONNULL FindLeaderRequest::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
  return ::new (mem) FindLeaderRequest(arena);
}
constexpr auto FindLeaderRequest::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(FindLeaderRequest),
                                            alignof(FindLeaderRequest));
}
constexpr auto FindLeaderRequest::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<FindLeaderRequest>(), &FindLeaderRequest::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull FindLeaderRequest_class_data_ =
        FindLeaderRequest::InternalGenerateClassData_();
...
FindLeaderRequest::_table_ = {
  {
    ...
    // string topic = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(FindLeaderRequest, _impl_.topic_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string topic = 1;
    {PROTOBUF_FIELD_OFFSET(FindLeaderRequest, _impl_.topic_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 partition = 2;
    {PROTOBUF_FIELD_OFFSET(FindLeaderRequest, _impl_.partition_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
    "\35\5\0\0\0\0\0\0"
...
::uint8_t* PROTOBUF_NONNULL FindLeaderRequest::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_topic().empty()) {
      const ::std::string& _s = this_._internal_topic();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.FindLeaderRequest.topic");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
...
void FindLeaderRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
class FindLeaderResponse::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<FindLeaderResponse>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_._has_bits_);
};
...
PROTOBUF_NDEBUG_INLINE FindLeaderResponse::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::streamit::v1::FindLeaderResponse& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        leader_host_(arena, from.leader_host_),
        error_message_(arena, from.error_message_) {}
...
FindLeaderResponse::FindLeaderResponse(
  ...
  new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
  ::memcpy(reinterpret_cast<char *>(&_impl_) +
               offsetof(Impl_, leader_broker_id_),
           reinterpret_cast<const char *>(&from._impl_) +
               offsetof(Impl_, leader_broker_id_),
           offsetof(Impl_, error_code_) -
               offsetof(Impl_, leader_broker_id_) +
...
inline void* PROTOBUF_NONNULL FindLeaderResponse::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
...
constexpr auto FindLeaderResponse::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          ::google::protobuf::Message::GetClearImpl<FindLeaderResponse>(), &FindLeaderResponse::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull FindLeaderResponse_class_data_ =
        FindLeaderResponse::InternalGenerateClassData_();
...
FindLeaderResponse::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(FindLeaderResponse, _impl_.leader_broker_id_), 2>(),
     {8, 2, 0, PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_.leader_broker_id_)}},
    // string leader_host = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 0, 0, PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_.leader_host_)}},
    // int32 leader_port = 3;
    ...
    {::_pbi::TcParser::FastUS1,
     {42, 1, 0, PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_.error_message_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    // int32 leader_broker_id = 1;
    {PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_.leader_broker_id_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // string leader_host = 2;
    {PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_.leader_host_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 leader_port = 3;
    {PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_.leader_port_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // .streamit.v1.ErrorCode error_code = 4;
    {PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_.error_code_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // string error_message = 5;
    {PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_.error_message_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\36\0\13\0\0\15\0\0"
...
// @@protoc_insertion_point(message_clear_start:streamit.v1.FindLeaderResponse)
  ...
  if ((cached_has_bits & 0x0000001cU) != 0) {
    ::memset(&_impl_.leader_broker_id_, 0, static_cast<::size_t>(
        reinterpret_cast<char*>(&_impl_.error_code_) -
        reinterpret_cast<char*>(&_impl_.leader_broker_id_)) + sizeof(_impl_.error_code_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
...
::uint8_t* PROTOBUF_NONNULL FindLeaderResponse::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001U) != 0) {
    if (!this_._internal_leader_host().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.FindLeaderResponse.leader_host");
      target = stream->WriteStringMaybeAliased(2, _s, target);
    }
  }
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000002U) != 0) {
    if (!this_._internal_error_message().empty()) {
      const ::std::string& _s = this_._internal_error_message();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "streamit.v1.FindLeaderResponse.error_message");
      target = stream->WriteStringMaybeAliased(5, _s, target);
    }
  }
...
::size_t FindLeaderResponse::ByteSizeLong() const {
  ...
  if ((cached_has_bits & 0x0000001fU) != 0) {
    ...
    if ((cached_has_bits & 0x00000004U) != 0) {
      if (this_._internal_leader_broker_id() != 0) {
        total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(
            this_._internal_leader_broker_id());
      }
    }
    // int32 leader_port = 3;
    if ((cached_has_bits & 0x00000008U) != 0) {
...
void FindLeaderResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
void FindLeaderResponse::InternalSwap(FindLeaderResponse* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.error_message_, &other->_impl_.error_message_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_.error_code_)
      ...
      - PROTOBUF_FIELD_OFFSET(FindLeaderResponse, _impl_.leader_broker_id_)>(
          ...
          reinterpret_cast<char*>(&other->_impl_.leader_broker_id_));
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_proto_2fstreamit_2eproto),
         ::std::false_type{});
