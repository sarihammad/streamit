...
public:
  ...
  // Add an index entry
  [[nodiscard]] Result<void> AddEntry(int64_t relative_offset, int64_t file_position, int32_t batch_size) noexcept;
  ...
  [[nodiscard]] Result<std::vector<IndexEntry>> GetEntries(int64_t from_offset, int64_t to_offset) const noexcept;
